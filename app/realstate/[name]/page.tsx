...
// // import { Users, Home, Building, CalendarClock, MessageCircle } from "lucide-react"
...
// //                 <Link href="/agent-dashboard/chats">
// //                     <button className="w-full flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-purple-50 rounded-lg transition-all">
...
//                 {/* 2-Column Layout: Left (main content) + Right (side widgets) */}
//                 <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
//                     {/* LEFT COLUMN: Quick Actions + Properties */}
//                     <div className="lg:col-span-2 space-y-8">
//                         <QuickActions
//                             quickActions={quickActions}
//                             clients={clients.length}
...
//                     {/* RIGHT COLUMN: Chats, Events, Clients, Owners */}
//                     <div className="space-y-8">
...
const EnhancedMetricCard = ({ title, value, icon, trend, subtitle, onClick, loading }: any) => {
    if (loading) {
        return <Skeleton active className="rounded-xl" />;
    }
    ...
    return (
        <motion.div
            ...
            className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer group"
            onClick={onClick}
        >
            <div className="flex items-center justify-between">
                ...
                <motion.div
                    className={`p-3 rounded-full bg-gradient-to-br ${icon.bgColor} group-hover:scale-110 transition-transform duration-300`}
...
// Quick Stat Card for additional metrics
const QuickStatCard = ({ title, value, icon, color }: any) => (
