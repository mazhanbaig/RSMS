...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="pt-20 pb-10 px-4">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="mt-4 text-sm sm:text-base text-gray-600 max-w-3xl mx-auto">
                        ZeeState is a real estate management system designed for agents who
                        want to organize clients, owners, and properties digitally — without
                        registers, diaries, or memory problems.
                    </p>
                </div>
            </section>
            ...
            <section className="py-10 px-4 bg-white">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        {[
                            "Client details written in registers and copies",
                            "Hundreds of registers after years of work",
                            "No easy way to find old clients",
                            "Phone contacts mixed with personal numbers",
                            "Wasting time on unnecessary property visits",
                            "No proper system for owners & properties"
                        ].map((item, i) => (
                            <div
                                key={i}
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <Feature
                            icon={<Users />}
                            title="Add Clients"
                            desc="Save buyer details, budget, location & house type in one place."
                        />
                        <Feature
                            icon={<Building />}
                            title="Add Owners"
                            desc="Store property owners information digitally & securely."
                        />
                        <Feature
                            icon={<Home />}
                            title="List Properties"
                            desc="Add properties with images, price, and full details."
                        />
                        <Feature
                            icon={<Eye />}
                            title="Virtual First"
                            desc="Show property images to clients before physical visits."
                        />
                    </div>
                </div>
            </section>

            {/* VIRTUAL FIRST EXPLANATION */}
            <section className="py-12 px-4 bg-white">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 text-center">
                        Instead of taking clients to multiple properties physically, agents
                        can first show property images according to budget, location, and
                        interest. Only shortlisted properties are visited physically.
                    </p>

                    <div className="grid gap-4 sm:grid-cols-3 mt-8">
                        <Benefit icon={<Clock />} text="Saves time for agents & clients" />
                        <Benefit icon={<Database />} text="No data loss, everything stored" />
                        <Benefit icon={<Home />} text="Visit only relevant properties" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            "Real estate agents",
                            "Property dealers",
                            "Small & large agencies",
                            "Independent brokers",
                            "Agents working with buyers & sellers",
                            "Anyone tired of registers & diaries"
                        ].map((item, i) => (
                            <div
                                key={i}
                                className="bg-white p-4 rounded-xl shadow-sm text-sm text-gray-700"
                            >
                                {item}
                            </div>
                        ))}
            ...
            {/* FINAL CTA */}
            <section className="py-14 px-4 bg-gradient-to-r from-purple-600 to-blue-600">
                <div className="max-w-4xl mx-auto text-center text-white">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-3">
                        Built for Real Estate Agents of Pakistan
                    </h2>
                    <p className="text-sm sm:text-base opacity-90">
                        ZeeState helps agents work smarter, faster, and more professionally
                        — without changing how real estate actually works.
                    </p>
                </div>
            </section>
        </div>
