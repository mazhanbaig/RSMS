...
import { Sparkles, Shield, Zap, TrendingUp, CheckCircle2 } from "lucide-react";
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 p-4">
            ...
            <div className="relative w-full max-w-4xl">
                ...
                >
                    ...
                    <div className="hidden lg:block lg:w-1/2 p-8 bg-gradient-to-br from-indigo-50/50 via-purple-50/30 to-pink-50/50 flex flex-col justify-center relative overflow-hidden">
                        {/* Decorative elements */}
                        ...
                        <div className="relative z-10">
                            <div className="mb-6">
                                ...
                                <p className="text-slate-500 text-xs">
                                    Transform your property workflow with ZState
                                </p>
                            </div>
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex items-center gap-2 group cursor-pointer">
                                    ...
                                    <p className="text-sm font-medium text-slate-700 group-hover:text-slate-900">AI Powered Management</p>
                                </div>
                                <div className="flex items-center gap-2 group cursor-pointer">
                                    ...
                                    <p className="text-sm font-medium text-slate-700 group-hover:text-slate-900">Real-time Property Updates</p>
                                </div>
                                <div className="flex items-center gap-2 group cursor-pointer">
                                    ...
                                    <p className="text-sm font-medium text-slate-700 group-hover:text-slate-900">Enterprise Security</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[
                                    { value: "15K+", label: "Properties", color: "text-indigo-600" },
                                    { value: "99%", label: "Satisfied", color: "text-purple-600" },
                                    { value: "24/7", label: "Support", color: "text-pink-600" }
                                ].map((stat, idx) => (
                                    <div key={idx} className="bg-white/60 backdrop-blur-sm rounded-xl p-2 text-center border border-slate-100 hover:border-purple-200 transition-all">
                    ...
                    <div className="lg:w-1/2 px-6 sm:px-8 py-8 flex flex-col justify-center">
                        ...
                        <div className="text-center mb-6">
                            ...
                            <p className="text-slate-500 text-sm">Sign in to access your property dashboard</p>
                        </div>
                        ...
                        <div className="mb-4">
                            <div className="flex items-center justify-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-slate-600">Join <span className="text-purple-600 font-bold">15,000+</span> properties</p>
                                </div>
                            </div>
                        </div>
