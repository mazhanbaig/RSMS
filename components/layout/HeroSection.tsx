...
//             id="home"
//             ref={containerRef}
//             className="relative min-h-screen w-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50/30"
//         >
...
export const HeroSection = () => {
    ...
    return (
        <section
            id="home"
            ref={containerRef}
            className="relative min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50/30"
        >
            {/* Immersive Light Background Effect */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_40%,rgba(99,102,241,0.04),transparent_50%)]" />
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex flex-col justify-center py-12 sm:py-16 md:py-0 overflow-visible">
                <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center overflow-visible">
                    {/* Left Column - Content */}
                    <div className="text-center lg:text-left overflow-visible w-full">
                        {/* Premium Badge */}
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <motion.div
                            ...
                            className="space-y-2"
                        >
                            <h1 className="text-5xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight break-words">
                                {headlineWords.map((word, idx) => (
                                    <motion.span
                                        key={idx}
                                        onHoverStart={() => !isMobile && setActiveWord(idx)}
                                        ...
                                        className={`inline-block mr-2 sm:mr-3 md:mr-4 relative whitespace-normal ${gradientWords.includes(word)
                                            ? "bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"
                                            : "text-slate-900"
                                            } transition-all duration-200 cursor-default`}
                                    >
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.7, delay: 0.3 }}
                            className="flex items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-8 sm:mt-10 flex-wrap"
                        >
                            <div className="flex -space-x-2">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-indigo-400 to-purple-400 border-2 border-white shadow-sm" />
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.7, delay: 0.4 }}
                            className="flex flex-wrap gap-2 sm:gap-3 mt-6 sm:mt-8 justify-center lg:justify-start"
                        >
                            {features.map((feature, idx) => (
                                <div key={idx} className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full ${feature.bg} border border-slate-100`}>
                                    <feature.icon size={12} className={`${feature.color} sm:w-[14px] sm:h-[14px]`} />
